...
class LookMapper(
    ...
    /**
     * @param sensitivity the platform's per-player sensitivity estimate (1.0 when unknown).
    ...
    fun sample(yaw: Float, pitch: Float, sensitivity: Double = 1.0): ScreenPos {
        ...
        // Wrap around the vertical axis based on pitch.
