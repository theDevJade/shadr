...
class EditorServer(
    ...
    /** Reads and writes the world programs an operator may override. */
     ...
     *
     * @param label who it was issued to, so it can be revoked by name.
    ...
    companion object {
        /** Default port, if not explained by the name clearly enough. */
