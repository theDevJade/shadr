...
class PageWriter {
    ...
    /**
     * @param file the page's source YAML.
     * @param original the page as loaded, before editing.
     * @param edited the page after editing.
     */
    ...
    // This should be rewritten later, @TODO make this better or smth.. i dont even know
