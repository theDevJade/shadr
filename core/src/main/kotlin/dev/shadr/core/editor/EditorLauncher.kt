...
object EditorLauncher {
    ...
    /**
     * @param dataFolder the plugin's data folder; the token file and a relative `ui-dir`
     *   resolve against it.
     * @param log receives operator-facing lines: the URL to open, and any warning.
     * @return the started server, or null when the editor is disabled.
     */
    fun start(
        ...
        // the available authored shaders
