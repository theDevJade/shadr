...
class HudPositionCalculator {
    ...
    /**
     * @param itemThickness non-zero only for ItemDisplays, whose model has depth: a block
     * model is half a unit deep, an item model a thirty-second.
     */
    ...
    /**
     * With `fix-shaders` on, layers are packed into a tiny epsilon range.
     * @param layer the original layer value.
     * @param layerGap the small epsilon range to pack layers into.
     * @return the adjusted layer value suitable for fixed-shader rendering.
     */
